...
<!-- Mirrored from techydevs.com/demos/themes/html/zobstar-demo/zobstar/job-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Oct 2023 12:36:29 GMT -->
<head>
                        ...
                        <div class="sidebar-option mb-4">
                            ...
                            <div class="user-chosen-select-container">
                                <select class="user-chosen-select">
                                    ...
                                    <option value="7">Engineer & Architects</option>
                                    <option value="8">Salons</option>
                                    <option value="9">Manufacturing jobs</option>
